...
assert.equal(/\nschedule:/.test(workflow), false, 'live production/Auth verification must remain explicitly manual');
...
console.log('OK Supabase production workflow is manual, pinned, project-locked, synthetic-Auth-capable and preflight-only');
