...
await caseStore.save({ id: 'case-1', owner_id: 'u1', state: 'draft', retention_mode: 'saved_case', documents: [], analyses: [], payments: [], created_at: '2026-08-18T12:00:00Z', updated_at: '2026-08-18T12:00:00Z', deleted_at: null });
...
console.log('OK case management');
